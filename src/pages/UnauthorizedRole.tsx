        ...
        switch (userRole) {
            case 'UNKNOWN':
                return {
                    ...
                    submessage: 'This usually takes 1-2 business days. You\'ll receive an email once your account is approved.',
                    icon: Clock,
            ...
            case 'SUSPENDED':
                return {
                    ...
                    submessage: 'Please contact support for more information about your account status.',
                    icon: AlertTriangle,
            ...
            case 'INACTIVE':
                return {
                    ...
                    submessage: 'Your account may have been deactivated due to inactivity or other reasons.',
                    icon: UserX,
            ...
            default:
                return {
                    ...
                    submessage: 'Your role is not recognized in our system. Please contact an administrator.',
                    icon: Lock,
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
            ...
            <main className="max-w-4xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <div className="relative w-full max-w-md mx-auto mb-8">
                        ...
                        >
                            ...
                            <g transform="translate(200, 160)">
                                <rect x="-20" y="-10" width="40" height="30" rx="4" fill="#9333EA" />
                                <path
                            ...
                            <g transform="translate(120, 100)">
                                ...
                                <line x1="20" y1="0" x2="40" y2="0" stroke="#E5E7EB" strokeWidth="2" strokeDasharray="4,4" />
                            </g>
                            ...
                            <g transform="translate(200, 280)">
                                ...
                                <circle cx="0" cy="-5" r="8" fill="#9CA3AF" />
                                <path d="M -12,10 Q -12,5 0,5 Q 12,5 12,10" fill="#9CA3AF" />
                                <line x1="0" y1="-20" x2="0" y2="-40" stroke="#E5E7EB" strokeWidth="2" strokeDasharray="4,4" />
                            </g>
                            ...
                            {userRole === 'UNKNOWN' && (
                                <g transform="translate(250, 130)">
                                    ...
                                    <path d="M 0,-8 L 0,2" stroke="#F59E0B" strokeWidth="3" strokeLinecap="round" />
                            ...
                            {userRole === 'UNKNOWN' && (
                                <g transform="translate(320, 200)">
                                    <circle cx="0" cy="0" r="25" fill="white" stroke="#E5E7EB" strokeWidth="2" />
                                    <circle cx="0" cy="0" r="2" fill="#6B7280" />
                                    <line x1="0" y1="0" x2="0" y2="-10" stroke="#6B7280" strokeWidth="2" strokeLinecap="round" />
                                    <line x1="0" y1="0" x2="8" y2="0" stroke="#6B7280" strokeWidth="2" strokeLinecap="round" />
                                </g>
                            )}
                        </svg>
                    </div>
                    ...
                    {/* Status Card */}
                    <div className={`max-w-2xl mx-auto ${statusInfo.bgColor} ${statusInfo.borderColor} border-2 rounded-xl p-8 mb-8`}>
                        ...
                        <div className="max-w-md p-4 mx-auto space-y-3 text-left bg-white rounded-lg">
                            ...
                            <div className="flex items-center justify-between py-2 border-b border-gray-100">
                                ...
                                <span className={`text-sm font-medium px-2 py-1 rounded-full ${userRole === 'UNKNOWN'
                            ...
                            <div className="flex items-center justify-between py-2">
                                ...
                                <span className="text-sm font-medium text-gray-900">{timeSinceRegistration()}</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="space-y-3 text-left">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">An administrator will review your account details</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <CheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                                    <div>
                                        <p className="text-sm font-medium text-gray-900">Role Assignment</p>
                                        <p className="text-sm text-gray-600">You'll be assigned an appropriate role based on your profile</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <CheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">You'll receive an email once your account is activated</p>
                                    </div>
                                </div>
                            </div>
                        </div>
