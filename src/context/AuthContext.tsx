...
import type { LoginRequest, RegisterRequest, RefreshTokenRequest } from '../types/request/auth';
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
    ...
    const saveTokens = useCallback(
        ...
        [decodeAndSetUser]
    ); // Now this only changes when decodeAndSetUser changes (which is stable)
